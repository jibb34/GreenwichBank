...
\title{COMP1610 Coursework Report \\ \large Programming Enterprise Components \\ \large Bank App Project}
...
\begin{center}
	\fbox{
		\begin{minipage}{0.9\linewidth}
			\textbf{Implementation Rating (1--5):} \underline{\hspace{1cm}}
		\end{minipage}
	}
\end{center}
...
\begin{itemize}
	...
	\item Transfer funds between accounts with validation.
...
\begin{itemize}
	...
	\item Responsive feedback and clean UI structure.
\end{itemize}
